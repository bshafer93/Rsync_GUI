...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.S_M_01.setItemText(0, _translate("MainWindow", "gold"))
        self.S_M_01.setItemText(1, _translate("MainWindow", "sword"))
        self.S_M_01.setItemText(2, _translate("MainWindow", "juno"))
        self.S_M_01.setItemText(3, _translate("MainWindow", "omaha"))
        ...
        self.D_M_01.setItemText(0, _translate("MainWindow", "gold"))
        self.D_M_01.setItemText(1, _translate("MainWindow", "sword"))
        self.D_M_01.setItemText(2, _translate("MainWindow", "juno"))
        self.D_M_01.setItemText(3, _translate("MainWindow", "omaha"))
